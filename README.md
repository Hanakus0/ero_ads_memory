| ... | ... |
| ---- | ---- |
| 2024/12/11 | READMEの整理 |
| 2024/12/5 | GA設定、X(旧Twitter) カード利用のためメタタグ追加 |
...
## アプリについての作成背景
### ポップアップ広告の考案者に影響
- ポップアップ広告について、ポップアップ広告のアイデアの発案者である Ethan Zuckerman 氏本人が発明したことに後悔の念があるという旨の記述を書籍で知ってから強く興味を持ったため
  - 私がポップアップ広告はよく目にするが実際に実装するとなるとどれほどの技術が必要なのか確かめたかったのも理由
  - 昨今問題になっている有名人などになりすました偽広告である"なりすまし広告"のニュースを見て悪意のある広告の存在を認知していたのもアイデアの種になった

### アートとしてのWebアプリ
- Webアプリというと「何か問題が存在していてそれを解決するための"手段"」にすぎないという論調があるが、私自身それに理解を示す一方で「"手段"ではない形のWebアプリ」があっても良いのではと考えた
  - 「"手段"ではない」=「それ自体の存在に価値がある」と考え、方針としては"アート"的なWebアプリを構想した
    - 手段は「問題を解決するために存在しているため、その問題を解決して価値が見いだされる」
    - アートは「それ自体には機能性も実用性も無いが、それ自体の存在（存在すること）に価値がある」


## 所感など
* ポップアップ広告の考案者である Ethan Zuckerman 氏がポップアップ広告を開発したことを後悔しているという記事を当アプリのポップアップ広告のリンクに載せるという皮肉がたっぷり利いたアート作品に仕立てられたので大変満足
